...
impl Renderer {
    ...
    fn pipeline_config(&self) -> ShaderPipelineConfig {
    ...
    pub fn register_shader<T: ShaderT>(&mut self) {
        let renderer = <T as ShaderT>::Renderer::new(&self.context, self.pipeline_config());
